...
async def call_gpt(text: str, profile: Dict[str, Any] = None, model: str = None, max_tokens: int = 1024) -> Dict[str, Any]:
    ...
    return await call_groq_chat(messages=messages, model=m, max_tokens=max_tokens)


def call_gpt_sync(text: str, profile: Dict[str, Any] = None, model: str = None, max_tokens: int = 1024) -> Dict[str, Any]:
    import asyncio

    return asyncio.get_event_loop().run_until_complete(call_gpt(text, profile, model, max_tokens))
